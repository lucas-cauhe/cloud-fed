...
define systemd::manage_unit (
  ...
  Optional[Systemd::Unit::NetDev]            $netdev_entry              = undef,
  Optional[Systemd::Unit::Bridge]            $bridge_entry              = undef,
  Optional[Systemd::Unit::Match]            $match_entry              = undef,
  Optional[Systemd::Unit::Network]            $network_entry              = undef,
  Optional[Systemd::Unit::BridgeVLAN]            $bridge_vlan_entry              = undef,
  Optional[Systemd::Unit::Peer]            $peer_entry              = undef,
  Optional[Systemd::Unit::PodmanNetwork]            $podman_network_entry              = undef,
  Optional[Systemd::Unit::Container]            $container_entry              = undef,
) {
  ...
  systemd::unit_file { $name:
	...
	'network_entry'  => $network_entry ? {
		undef => $podman_network_entry,
		default => $network_entry
	},
	'bridgevlan_entry'  => $bridge_vlan_entry,
