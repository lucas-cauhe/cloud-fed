class storage::ceph::vars {
	...
	$network = {
		'10' => {
			'osds' => [
				{'hostname' => 'osd-0-10', 'ipaddress' => '192.168.10.80', 'cluster_ipaddress' => '192.168.110.80'},
				{'hostname' => 'osd-1-10', 'ipaddress' => '192.168.10.81', 'cluster_ipaddress' => '192.168.110.81'},
				{'hostname' => 'osd-2-10', 'ipaddress' => '192.168.10.82', 'cluster_ipaddress' => '192.168.110.82'},
				{'hostname' => 'osd-3-10', 'ipaddress' => '192.168.10.83', 'cluster_ipaddress' => '192.168.110.83'},
				{'hostname' => 'osd-4-10', 'ipaddress' => '192.168.10.84', 'cluster_ipaddress' => '192.168.110.84'},
			],
			'mon' => [
			...
			'ceph_cluster_net' => '192.168.110.0/24',
			'ceph_public_net' => '192.168.10.0/24'
		},
		'20' => {
			'osds' => [
				{'hostname' => 'osd-0-20', 'ipaddress' => '192.168.20.80', 'cluster_ipaddress' => '192.168.120.80'},
				{'hostname' => 'osd-1-20', 'ipaddress' => '192.168.20.81', 'cluster_ipaddress' => '192.168.120.81'},
				{'hostname' => 'osd-2-20', 'ipaddress' => '192.168.20.82', 'cluster_ipaddress' => '192.168.120.82'},
				{'hostname' => 'osd-3-20', 'ipaddress' => '192.168.20.83', 'cluster_ipaddress' => '192.168.120.83'},
				{'hostname' => 'osd-4-20', 'ipaddress' => '192.168.20.84', 'cluster_ipaddress' => '192.168.120.84'},
			],
			'mon' => [
			...
			'network_gateway' => '10.88.0.144',
			'ceph_cluster_net' => '192.168.120.0/24',
