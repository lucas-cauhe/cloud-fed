...
#
# Load policy compliance test
#

if action == "one.vm.allocate" or action == "one.image.allocate"
  # get metrics
  # opennebula_host_cpu_usage_ratio and opennebula_datastore_total_bytes and opennebula_datastore_free_bytes
